...
<div id="chooseReportBox">
  ...
  <select name="serviceSubType">
    ...
    <option value="2">Disconnected orders per period</option>
    <option value="3">Profitability by month</option>
    <option value="4">Most profitable router</option>
    <option value="5">Routers utilization and capacity</option>
  </select>
  </td>
  </tr>
    <tr>
