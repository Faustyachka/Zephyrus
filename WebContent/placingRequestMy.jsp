...
<body>
	<table border="2" bordercolor="black">
		<tr>
			...
			<td>Your desired location: <input type="text" name="address"
				id="address" size="66" /> <input type="button" value="Accept"
				id="submit" />
				<div id="somediv"></div> <input type="button"
				value="Proceed to order" id="proceed" />
			</td>
		</tr>
	</table>
