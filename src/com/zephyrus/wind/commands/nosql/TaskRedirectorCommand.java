 ...
 * It is supposed to redirect user from page with tasks to page of task processing.
 * 
...
public class TaskRedirectorCommand implements Command {
	...
	/**
  	 * This method redirects user from tasks page to processing task page 
  	 * in dependence of scenario. 
